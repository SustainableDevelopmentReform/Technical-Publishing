...
+ A thorough analysis of the measurement and verification standards landscape ensures that investments within the AIX contribute to social, socio-economic and environmental goals. The meta-governance structure should integrate the critical aspects of commonly used standards tailored to different socially responsible investing strategies. For company reporting, frameworks such as the Global Reporting Initiative (#cite(<gri2021>, form: "prose");), the Taskforce on Nature-related Financial Disclosures (#cite(<tnfd_2024>, form: "prose");), the Task Force on Climate-related Financial Disclosures (#cite(<tcfd_2024>, form: "prose");), and the Sustainability Accounting Standards Board (SASB) provide essential guidelines for companies to report their ESG performance.
